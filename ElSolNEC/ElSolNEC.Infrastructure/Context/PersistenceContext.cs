...
namespace ElSolNEC.Infrastructure.Context;
...
public partial class PersistenceContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=company_cristhian;Username=elsolnec;Password=elsolnec");
